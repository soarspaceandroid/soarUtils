 ...
 * <pre>
 *  CharSequence chars = StringColorUtils.from("I'm<Chinese>,I love <China>").
 *                                                              withSeparator("<>").
...
public class StringColorUtils {
	...
	public static StringColorUtils from(Fragment f, int patternResourceId) {
	 ...
	 *             if pattern contains any syntax errors.
	 */
	public static StringColorUtils from(View v, int patternResourceId) {
	 ...
	 *             if pattern contains any syntax errors.
	 */
	public static StringColorUtils from(Context c, int patternResourceId) {
	 ...
	 *             if pattern contains any syntax errors.
	 */
	public static StringColorUtils from(Resources r, int patternResourceId) {
	 ...
	 *             if pattern contains any syntax errors.
	 */
	public static StringColorUtils from(CharSequence pattern) {
		return new StringColorUtils(pattern);
	}

	private StringColorUtils(CharSequence pattern) {
	 ...
	 * @return
	 */
	public StringColorUtils withSeparator(String _separator) {
	 ...
	 * @return
	 */
	public StringColorUtils outerColor(int _outerColor) {
	 ...
	 * @return
	 */
	public StringColorUtils innerColor(int _innerColor) {
