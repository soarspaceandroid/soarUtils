...
public class GesturePoint {
    ...
    public void setPointState(int state) {
        pointState = state;
        switch (state) {
            case GestureContentView.POINT_STATE_NORMAL:
                this.image.setBackgroundResource(R.mipmap.gesture_node_normal);
                break;
            case GestureContentView.POINT_STATE_SELECTED:
                this.image.setBackgroundResource(R.mipmap.gesture_node_selected);
                break;
            case GestureContentView.POINT_STATE_WRONG:
