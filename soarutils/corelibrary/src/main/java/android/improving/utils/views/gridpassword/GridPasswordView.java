package android.improving.utils.views.gridpassword;
...
import android.improving.utils.tools.DensityUtils;
import android.improving.utils.views.gridpassword.imebugfixer.ImeDelBugFixedEditText;
...
/**
 * ●
 *<android.improving.utils.views.gridpassword.GridPasswordView
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.mTextSize =(int) DensityUtils.px2sp(context, textSize);
        }

        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, DensityUtils.dp2px(getContext(), 1));
