package android.improving.utils.views.yummytext;
...
public class YummyTextSwitcher extends View {
    ...
    private void init() {
        ...
        mMaskFilterFirst = new BlurMaskFilter(1, BlurMaskFilter.Blur.NORMAL);
        mMaskFilterSecond = new BlurMaskFilter(1, BlurMaskFilter.Blur.NORMAL);
        mMaskFilterMiddle = new BlurMaskFilter(1, BlurMaskFilter.Blur.NORMAL);
