...
public class SwipeBackLayout extends FrameLayout {
	 ...
	 * callback's
	 * {@link android.improving.utils.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
	 * and
	 * {@link android.improving.utils.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
